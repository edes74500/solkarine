...
const RaiderIoCard: React.FC<Props> = ({ data }) => {
  ...
  return (
    <Card className="overflow-hidden max-w-sm dark:bg-black/70 bg-tertiary drop-shadow-md">
      <CardHeader className="!mb-0 !pb-0 !text-white">
        <div className="flex items-center gap-4 bg-stone-700 dark:bg-card/50 p-3 rounded-md">
          {data.thumbnail_url && (
