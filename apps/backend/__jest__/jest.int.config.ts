...
const config: Config = {
  ...
  testMatch: ["<rootDir>/__test__/**/*.int.test.ts", "<rootDir>/__test__/**/*.spec.ts"],
  setupFiles: ["<rootDir>/__jest__/env.int.ts"], // ← ENV + suffixe
  setupFilesAfterEnv: ["<rootDir>/__jest__/setup.int.ts"],
  transform: {
  ...
  // Correction pour éviter l'erreur "testPathPattern was replaced by --testPathPatterns"
};
